try:
             ...
             obj=array()
             lst=[]#list is created
             length=int(input("Enter  a length of a list:"))#length of the list
             ...
             while(c=='y'):
                          ...
                          print("Enter '8' to sort a list in ascending")
             ...
             print("Oops!! something went wrong !!! Kindly check your code:")
